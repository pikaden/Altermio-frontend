        ...
        <div className="landing__container">
            <div className="landing__header__container">
                <div className="landing__header">
                    <h1 className="landing__header__main">Checkout Your Favorite Secondhand</h1>
                    <h3 className="landing__header__discount">Every product deserves a second chance</h3>
                    <Link to="/shop">
